...
class Gui:
    ...
    def ap(self):
        try:
            ...
            self.register = Button(self.wn, text="Register", bg='green', fg='blue', font=('Ariel', 14),
                                  command=self.register)

            self.register.pack(padx=10, pady=10)
            self.login = Button(self.wn, text="Login", bg='green', fg='blue', font=('Ariel', 14), command=self.login)
    ...
    def login(self):
        try:
            ...
            self.system_login = Label(self.wn1, text=" Enter the details for system login", font=('Ariel', 14, 'italic'))
            ...
            self.submit= Button(self.wn1, text='Login', font=('Ariel', 14, 'italic'),bg='green',command=self.login_user)
    ...
    def register(self):
        try:
            ...
            self.submit = Button(self.wn2, text='Save', font=('Ariel', 14, 'italic'),bg='green', command=self.register_user)
            self.submit.place(x=140, y=240)
            self.submit = Button(self.wn2, text='Back', font=('Ariel', 14, 'italic'),bg='red',command=self.back_button)
    ...
    def dashboard(self):
        try:
            ...
            self.patient = Button(self.ns, text="Patient", bg='orange', fg='blue', font=('Ariel', 14 ), command=self.pat.patient1)
            self.patient.pack(padx=10,pady=10)
            self.doctor = Button(self.ns, text="Doctor", bg='orange', fg='blue', font=('Ariel', 14),command=self.doc.doctor1)
            self.doctor.pack(padx=10,pady=10)
            self.appointment = Button(self.ns, text="Appointment", bg='orange', fg='blue', font=('Ariel', 14), command=self.app.appoint)
...
class Patient:
    ...
    def patient1(self):
        ...
        try:
            ...
            self.prakash = Button(self.ns1, text='Save', font=('Ariel', 14, 'italic'),bg='green' ,command=self.patient_user)
            self.prakash.place(x=20, y=500)
            self.prakash1 = Button(self.ns1, text='Update', font=('Ariel', 14, 'italic'), bg='yellow',command=self.update_user)
            self.prakash1.place(x=130, y=500)
            self.prakash2 = Button(self.ns1, text='Delete', font=('Ariel', 14, 'italic'),bg='red', command=self.delete_user)
            self.prakash2.place(x=250, y=500)
            self.prakash9 = Button(self.ns1, text='Back', font=('Ariel', 14, 'italic'), bg='red',command=self.back_button)
...
class Doctor:
    ...
    def doctor1(self):
        try:
            ...
            self.prakash = Button(self.ns2, text='Save', font=('Ariel', 14, 'italic'),bg='green', command=self.doctor_user)
            self.prakash.place(x=170, y=250)
            self.prak = Button(self.ns2, text='Back', font=('Ariel', 14, 'italic'), bg='red',command=self.ns2.destroy)
            self.prak.place(x=170, y=300)
            self.prakash3 = Button(self.ns2, text='Update', font=('Ariel', 14, 'italic'),bg='yellow', command=self.update_user1)
            self.prakash3.place(x=50, y=250)
            self.prakash4 = Button(self.ns2, text='Delete', font=('Ariel', 14, 'italic'),bg='red', command=self.delete_user1)
...
class Appoint:
    ...
    def appoint(self):
        try:
            ...
            self.prakash = Button(self.ns3, text='Save', font=('Ariel', 14, 'italic'),bg='green', command=self.appoint_user)
            self.prakash.place(x=170, y=215)
            self.pra = Button(self.ns3, text='Back', font=('Ariel', 14, 'italic'),bg='red', command=self.ns3.destroy)
            self.pra.place(x=170, y=260)
            self.prakash = Button(self.ns3, text='Update', font=('Ariel', 14, 'italic'),bg='yellow', command=self.update_user2)
            self.prakash.place(x=50, y=220)
            self.prakash = Button(self.ns3, text='Delete', font=('Ariel', 14, 'italic'), bg='green',command=self.delete_user2)
            self.prakash.place(x=300, y=220)

            self.lbl3 = Label(self.ns3, text='Search', font=('Ariel', 14, 'italic'))
            self.lbl3.place(x=20, y=350)

            self.prakash8 = Button(self.ns3, text='Select', font=('Ariel', 14, 'italic'),bg='green', command=self.search2)
