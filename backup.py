...
class Gui:
    ...
    def register(self):
        try:
            ...
            # self.submit = Button(self.wn2, text='Back', font=('Ariel', 14, 'italic'), command=self.back_button)
    ...
    def dashboard(self):
        try:
            ...
            self.patient = Button(self.ns, text="Patient", bg='yellow', fg='blue', font=('Ariel', 14),
                                  command=self.pat.patient1)
            self.patient.pack(padx=10, pady=10)
            self.doctor = Button(self.ns, text="Doctor", bg='yellow', fg='blue', font=('Ariel', 14),
                                 command=self.doc.doctor1)
            self.doctor.pack(padx=10, pady=10)
            self.appointment = Button(self.ns, text="Appointment", bg='yellow', fg='blue', font=('Ariel', 14),
                                      command=self.app.appoint)
...
class Doctor:
    ...
    def doctor1(self):
        try:
            ...
            self.prak = Button(self.ns2, text='Back', font=('Ariel', 14, 'italic'), command=self.back_button)
...
class Appoint:
    ...
    def appoint(self):
        try:
            ...
            self.pra = Button(self.ns3, text='Back', font=('Ariel', 14, 'italic'), command=self.back_button)
