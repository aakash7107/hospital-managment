...
class Gui:
    ...
    def ap(self):
        try:
            ...
            self.register = Button(self.wn, text="Register", bg='yellow', fg='blue', font=('Ariel', 14),
                                  command=self.register)

            self.register.pack(padx=10, pady=10)
            self.login = Button(self.wn, text="Login", bg='yellow', fg='blue', font=('Ariel', 14), command=self.login)
    ...
    def login(self):
        try:
            ...
            self.submit= Button(self.wn1, text='Login', font=('Ariel', 14, 'italic'),command=self.login_user)
    ...
    def register(self):
        try:
            ...
            self.wn2.title('Hospital management system')
            ...
            self.submit = Button(self.wn2, text='Save', font=('Ariel', 14, 'italic'), command=self.register_user)
            self.submit.place(x=170, y=240)
            self.wn2.mainloop()
        except Exception as e:
            print(e)

    def register_user(self, name, email, contact, un, pw):
        try:
    ...
    def login_user(self,username1,password1):
        try:
            self.db = Aakash()
    ...
    def dashboard(self):
        try:
            ...
            self.patient = Button(self.ns, text="Patient", bg='yellow', fg='blue', font=('Ariel', 14 ), command=self.pat.patient1)
            self.patient.pack(padx=10,pady=10)
            self.doctor = Button(self.ns, text="Doctor", bg='yellow', fg='blue', font=('Ariel', 14),command=self.doc.doctor1)
            self.doctor.pack(padx=10,pady=10)
            self.appointment = Button(self.ns, text="Appointment", bg='yellow', fg='blue', font=('Ariel', 14), command=self.app.appoint)
...
class Patient:
    ...
    def patient1(self):
        try:
            ...
            self.prakash9 = Button(self.ns1, text='Back', font=('Ariel', 14, 'italic'), command=self.dashboard)
            self.prakash9.place(x=370, y=500)
    ...
    def patient_user(self,patient_name, address, age, gender, phone_number, admitted_date, diseases, ward_number):
        try:
            self.db = Aakash()
    ...
    def update_user(self,name, add, age, gender, admit_date, disease, ward, phone, id):
        try:
            self.db = Aakash()
            # name = self.name_ent.get()
...
class Doctor:
    ...
    def doctor1(self):
        try:
            ...
            self.prakash = Button(self.ns2, text='Save', font=('Ariel', 14, 'italic'), command=self.doctor_user)
            self.prakash.place(x=170, y=250)
            self.prak = Button(self.ns2, text='Back', font=('Ariel', 14, 'italic'), command=self.dashboard)
            self.prak.place(x=170, y=300)
            self.prakash3 = Button(self.ns2, text='Update', font=('Ariel', 14, 'italic'), command=self.update_user1)
            self.prakash3.place(x=50, y=250)
            self.prakash4 = Button(self.ns2, text='Delete', font=('Ariel', 14, 'italic'), command=self.delete_user1)
...
class Appoint:
    ...
    def appoint(self):
        try:
            ...
            self.prakash = Button(self.ns3, text='Save', font=('Ariel', 14, 'italic'), command=self.appoint_user)
            self.prakash.place(x=170, y=215)
            self.pra = Button(self.ns3, text='Back', font=('Ariel', 14, 'italic'), command=self.dashboard)
            self.pra.place(x=170, y=260)
            self.prakash = Button(self.ns3, text='Update', font=('Ariel', 14, 'italic'), command=self.update_user2)
            self.prakash.place(x=50, y=220)
            self.prakash = Button(self.ns3, text='Delete', font=('Ariel', 14, 'italic'), command=self.delete_user2)
            self.prakash.place(x=300, y=220)

            self.lbl3 = Label(self.ns3, text='Search', font=('Ariel', 14, 'italic'))
            self.lbl3.place(x=20, y=350)

            self.prakash8 = Button(self.ns3, text='Select', font=('Ariel', 12, 'italic'), command=self.search2)
